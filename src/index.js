  ...
  actionItems: [
    {
      ...
      btnContent: (
        <a
          href="mailto:contact@headline.dev"
          aria-label="Email"
          class="Header__StyledGlobalAction-sc-14tpcyv-1 hzqpaE bx--header__action-1"
          type="button"
        >
          <svg
            focusable="false"
  ...
  render() {
    return (
      <React.Fragment>
        ...
        />
        <SideNav links={links} isSideNavExpanded={true} />
        <footer
          aria-label="HEADLINE INC"
          href="https://twitter.com/headline_crypto"
          label="HEADLINE INC"
          target="_blank"
          class="bx--side-nav__link disabled"
        >
          <svg
            id="Layer_1"
            width={200}
          ...
          <span class="bx--side-nav__link-text footer-text">
            HEADLINE is a fintech startup and media company.
            <br />
            We build software on the Algorand blockchain. Copyright © 2023
            HEADLINE INC. Built with React.js and Carbon Design
          </span>
        </footer>
      </React.Fragment>
    );
